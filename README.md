...
After configuration, all you have to do is open Vita FTP on the desired Vita/TV consoles. This script will then connect to each, backup your saves directory, and sync your most recent saves to out-of-date devices. Only the most recent save files found will be shared to other Vita/TV devices, and a redundant set of backups are pushed to the synchronization host to help prevent data loss.
